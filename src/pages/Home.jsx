    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
        ...
        {heroImages.map((_, i) => (
          <button
            ...
            className={`w-[3px] transition-all duration-700 ${
              i === currentSlide ? 'h-10 bg-gold-500' : 'h-4 bg-white/20 hover:bg-white/40'
            }`}
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE LIMITS ', 'GET', ' DESTROYED.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-gold-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-gold-400 hover:shadow-xl hover:shadow-gold-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Xtreme Fitness Total Body Gym &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['STRENGTH', 'CARDIO', 'HIIT', 'YOGA', 'PERSONAL TRAINING', 'NUTRITION'];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            <Link
              to="/services"
              className="group text-white/30 text-xs uppercase tracking-[0.2em] flex items-center gap-2 hover:text-gold-500 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              All Services
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              ...
              {i < stats.length - 1 && (
                <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 h-16 w-[1px] bg-gradient-to-b from-transparent via-gold-500/15 to-transparent" />
              )}
            </motion.div>
          ))}
        </div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Xtreme Fitness Total Body Gym showcase"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Xtreme Fitness Total Body Gym detail"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Premium Equipment', desc: 'State-of-the-art machines and free weights from leading international brands.' },
    { title: 'Certified Trainers', desc: 'Every trainer is nationally certified with ongoing education in the latest fitness science.' },
    { title: 'Community Spirit', desc: 'A supportive, judgment-free environment where everyone pushes each other to improve.' },
    { title: 'Flexible Hours', desc: 'Early morning to late evening hours that fit around your work and life schedule.' }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              alt="Xtreme Fitness Total Body Gym quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
            <div className="absolute -top-3 -left-3 w-20 h-20 border-t-2 border-l-2 border-gold-500/40" />
            <div className="absolute -bottom-3 -right-3 w-20 h-20 border-b-2 border-r-2 border-gold-500/40" />
          </motion.div>
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Xtreme</span>
            </h2>
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-12 h-12 rounded-full object-cover object-center border-2 border-gold-500/30"
                    loading="lazy"
                  />
                )}
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt="Xtreme Fitness Total Body Gym"
